...
class CSSTipVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        autoreleasepool {
            self.navigationItem.title = "\(tipNameCSS[myIndexCSS])"
            
            let layoutManager = NSLayoutManager()
            textStorage.addLayoutManager(layoutManager)
            
            code = "\(tipInfoCSS[myIndexCSS])"
            ...
            textStorage.language = "\(tipLanguageCSS[myIndexCSS])"
...
extension CSSTipVC: UITextViewDelegate {
    func addToolBar(textView: UITextView){
        ...
        let tabButton = UIBarButtonItem(image: UIImage.init(named: "select-column"), style: UIBarButtonItemStyle.done, target: self, action: #selector(CSSTipVC.indentWithTab))
        
        let cancelButton = UIBarButtonItem(image: UIImage.init(named: "DropDown"), style: UIBarButtonItemStyle.plain, target: self, action: #selector(CSSTipVC.closeKeyboard))
